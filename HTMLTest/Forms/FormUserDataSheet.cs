...
{
    public partial class FormUserDataSheet : Form
    {
        ...
        private void updateHtmlPreviewPage(object sender, EventArgs e)
        {
            ...
            } else
            {
                ...
                // HTML
                string mobilePhoneNumberText = "+36 " + comboBoxMobileNumberBeginning.Text + " " + textBoxMobile.Text.Substring(0, 3) + " " + textBoxMobile.Text.Substring(3, 4);
                ...
                // TXT
                //mobilePhoneNumberText = "M +36 " + comboBoxMobileNumberBeginning.Text + " " + textBoxMobile.Text.Substring(0, 3) + " " + textBoxMobile.Text.Substring(3, 4);
